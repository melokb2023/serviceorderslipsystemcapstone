            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100" style="background-color:#d70021;font-family: 'Century Gothic', sans-serif; font-weight: bold;">
                    ...
                    @foreach($users as $user)
                        <form method="POST" action="{{ route('user-updateusertype',['id' => $user->id]) }}">
                            @csrf
                            @method('patch')
                      <div class="flex-items-center">
                                <label for="Please Enter Your New Password">Change User Type:</label>
                                <div>
                                    <select name="xusertype" class="form-control">
