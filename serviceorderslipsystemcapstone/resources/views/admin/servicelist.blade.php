 ...
 <div class="flex justify-center items-center h-screen">
        <div>
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 text-white dark:text-gray-100" style="border:3 px solid black;background-color:#d70021;width: 800px;">
                    <h1 class="text-3xl font-bold mb-6" style="color:white;text-align:center">List of Services Done By The Company</h1>
                        <div class="mb-8" style="border:3 px solid black" style="background-color:  #d70021;width: 800px;">
                            <ol class="list-decimal" style="border:3 px solid black">
