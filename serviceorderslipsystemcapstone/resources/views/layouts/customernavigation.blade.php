...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
                ...
                <div style="border: 3px solid #CD5C5C;background-color:#CD5C5C;font-weight:bold;padding-bottom: 39px;overflow: hidden;"> 
                  <a class="top-nav" style="border: 3px solid black;background-color:white;padding-bottom: 39px;padding-top:3px" href="{{ route('startappointment') }}" :active="request()->routeIs('startappointment')">
...
<a class="top-nav" style="border: 3px solid black;background-color:white;padding-bottom: 39px;padding-top:3px" href="{{ route('add-customerrating') }}" :active="request()->routeIs('add-customerrating')">
                        {{ __('RATE THE SERVICE') }}
</a>
                </div>
            </div>
